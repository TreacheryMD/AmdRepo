...
namespace MyModel
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var allBankAccounts = BAccountsRepo.GetAll<BankAccount>();
            ...
            //foreach (var account in BAccountsRepo.GetAll<CreditAccount>())
            //{
            //    Console.WriteLine(account.ToString());
            //}

            var ceva = BAccountsRepo.RunQuerryOverExample2();
